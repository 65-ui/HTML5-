...
+ [1-5 浏览器和网页](#1-5-浏览器和网页)
    * [5.1 浏览器的问题](#5.1-浏览器的问题)
    * [5.2 W3C 的建立](#5.2-w3c-的建立)
    * [5.3 网页的结构思想](#5.3-网页的结构思想)
        - [5.3.1. 根据 W3C 标准，一个网页主要由三部分组成：结构、表现还有行为。](#5.3.1.-根据-w3c-标准，一个网页主要由三部分组成：结构、表现还有行为。)
        - [5.3.2. 结构、表现、行为](#5.3.2.-结构、表现、行为)
+ [1-6 网页的基本结构](#1-6-网页的基本结构)
    * [6.1 迭代](#6.1-迭代)
    * [6.2 文档声明（doctype）](#6.2-文档声明（doctype）)
    * [6.3 字符编码](#6.3-字符编码)
        - [6.3.1 编码](#6.3.1-编码)
        - [6.3.2 解码](#6.3.2-解码)
        - [6.3.3 字符集（charset）](#6.3.3-字符集（charset）)
        - [6.3.4 乱码](#6.3.4-乱码)
    * [6.4 常见的字符集](#6.4-常见的字符集)
        - [6.4.1 ASCII](#6.4.1-ascii)
        - [6.4.2 ISO-8859-1](#6.4.2-iso-8859-1)
        - [6.4.3 GB2312](#6.4.3-gb2312)
        - [6.4.4 GBK](#6.4.4-gbk)
        - [6.4.5 Big5](#6.4.5-big5)
        - [6.4.6 UTF-8](#6.4.6-utf-8)
        - [6.4.7 UTF-16](#6.4.7-utf-16)
        - [6.4.8 Unicode](#6.4.8-unicode)
+ [1-7 HTML5 的基本结构](#1-7-html5-的基本结构)
...
### 5.3.1. 根据 W3C 标准，一个网页主要由三部分组成：结构、表现还有行为。
...
ASCII 码表：[Ascii Table - ASCII character codes and html, octal, hex and decimal chart conversion](https://www.asciitable.com/mobile/)
